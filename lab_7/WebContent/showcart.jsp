...
<div id="header">
	<a href="shop.html">Home</a> <a href="listprod.jsp?productName=">List
		of Products</a> <a href="showcart.jsp">Shopping Cart</a> <a
		href="listorder.jsp">List of Orders</a>
</div>
	...
	<%
		...
		if (!(request.getParameter("update") == null || request.getParameter("update").equals(""))) {
			...
			if (productList.containsKey(request.getParameter("delete"))){
				productList.remove(productList.get(request.getParameter("delete")));
			}
