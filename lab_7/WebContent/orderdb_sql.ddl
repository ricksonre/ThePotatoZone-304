...
CREATE TABLE reviews (
	...
	FOREIGN KEY (productId) REFERENCES product(productId)
		ON UPDATE CASCADE ON DELETE NO ACTION,
	FOREIGN KEY (cname) REFERENCES customer(customerId)
		ON UPDATE CASCADE ON DELETE NO ACTION
...
INSERT INTO warehouse (warehouseName) VALUES ('ISS');
INSERT INTO warehouse (warehouseName) VALUES ('Moon Base');

INSERT INTO productinventory (productId, warehouseId, quantity) VALUES (5, 1, 13);
INSERT INTO productinventory (productId, warehouseId, quantity) VALUES (2, 1, 5);
INSERT INTO productinventory (productId, warehouseId, quantity) VALUES (7, 1, 4);
INSERT INTO productinventory (productId, warehouseId, quantity) VALUES (5, 2, 8);
INSERT INTO productinventory (productId, warehouseId, quantity) VALUES (4, 2, 1);
...
INSERT INTO review (reviewRating,customerId,productId,reviewComment) VALUES('3',2, 7, 'cows bad');
